...
return [
    'process_admin' => ['config.manage', 'users.manage', 'projects.manage', 'workflow.manage', 'integrations.manage', 'leads.view', 'reports.sales', 'reports.financial', 'reports.activity', 'partners.manage'],
    ...
    'crm_head' => ['crm.view', 'crm.manage', 'postsales.manage', 'leads.view', 'leads.edit', 'reports.activity', 'partners.manage'],
